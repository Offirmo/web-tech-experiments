http://www.codeproject.com/Messages/4209163/Minor-update-for-my-uses.aspx
/*-------------------------------------------------------------------------------------------
|     ECOTree.js
|--------------------------------------------------------------------------------------------
...
|	  Last Updated: March 29, 2012, Andy Button
|     Version: 1.5.1 - Added some customisations to override plus/minus if not required
|                      Including text coloring, node type overrides and nodeHTML which probably
|                      needs looking at for external use as I know nothing about XSS etc
|
...
ECOTree.prototype.add = function (id, pid, dsc, w, h, c, bc, target, meta, noCollapse, nodeHTML, forceColor, textColor) {
	...
	var node = new ECONode(id, pid, dsc, nw, nh, color, border, tg, metadata, noCollapse, nodeHTML, forceColor, textColor);  //New node creation...
