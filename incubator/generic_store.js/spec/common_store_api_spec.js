...
function(chai) {
	...
	var should_implement_store_js_api = function() {
		describe('store.js API implementation [shared]', function() {
			...
			it('should be able to store objects but NOT store them by reference', function() {
				var out = this.CUT.make_new();
			...
			it('should be able to fetch objects but NOT serve them through a common reference', function() {
				var out = this.CUT.make_new();
